...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::Login( 
   BLOB userInfo,
   BLOB pwdInfo,
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::Logout(void)
{
   BOOL postResult = 0;
   HRESULT hr = S_OK;
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::Authenticate(
   BLOB userInfo,
   BLOB pwdInfo)
{
   LOGIN_CONTEXT* pLoginCtx = NULL;
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::VerifyPermission(
   BSTR bstrPermission,
   VARIANT* pContext)
{
   LOGIN_CONTEXT* pLoginCtx = NULL;
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::CreateCredentialsFilePath()
{
   HRESULT hr = S_OK;
   BOOL b = FALSE;
