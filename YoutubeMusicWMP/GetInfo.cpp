...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::GetItemInfo(
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::GetContentPartnerInfo(
   BSTR bstrInfoName,
   VARIANT *pData)
{
   HRESULT hr = S_OK;
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::GetStreamingURL( 
   WMPStreamingType st,
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::GetCatalogURL( 
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::GetTemplate( 
   WMPTaskType task,
   BSTR location,
   VARIANT* /*pContext*/,
   BSTR /*clickLocation*/,
