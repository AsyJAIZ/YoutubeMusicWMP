...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::StartContentPartnerThread(ContentPartnerThreadType threadType)
{
   DWORD waitResult = 0;
   HRESULT hr = S_OK;
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::ShutdownThreads()
{
   BOOL postResult = 0;
   HRESULT hr = S_OK;
