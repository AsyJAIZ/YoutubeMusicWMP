...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::SetCallback(
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::Notify(
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::StationEvent( 
