...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::CanBuySilent( 
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::Buy( 
   IWMPContentContainerList *pInfo,
   DWORD cookie)
{
...
HRESULT STDMETHODCALLTYPE YoutubeMusicWMP::CompareContainerListPrices( 
